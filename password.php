                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <div class="small mb-3 text-muted">Masukan email anda dan kami akan mengirimkan tautan untuk memasukan ulang kata sandi.</div>
                                        <form>
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="register.php">Perlu akun? Daftar!</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
